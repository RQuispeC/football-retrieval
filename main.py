...
save_dir = "/home/leodecio/Área de Trabalho/Unicamp/1st_semester/recuperacao_de_informacao/pesquisa/log"
...
plot_position(match[0], save_dir)
plot_position(match[1], save_dir)
plot_position(match[2], save_dir)
